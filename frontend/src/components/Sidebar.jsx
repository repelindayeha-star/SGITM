...
// Cada item solo aparece si el rol tiene permiso real de "ver" ese recurso
// (ver src/utils/permisos.js). El Administrador, por diseno, solo ve
// Panel general, Clientes, Inventario y Facturacion -- nunca la operacion
// diaria del taller (motos, citas, ordenes), que es tarea de Recepcionista
// y Mecanico.
const ITEMS_MENU = [
  { to: '/dashboard', etiqueta: 'Panel general', icono: LayoutDashboard, roles: ['ADMINISTRADOR', 'RECEPCIONISTA'] },
  { to: '/clientes', etiqueta: 'Clientes', icono: Users, roles: ['ADMINISTRADOR', 'RECEPCIONISTA', 'MECANICO'] },
  { to: '/motocicletas', etiqueta: 'Motocicletas', icono: Bike, roles: ['RECEPCIONISTA', 'MECANICO'] },
  { to: '/citas', etiqueta: 'Citas', icono: CalendarClock, roles: ['RECEPCIONISTA', 'MECANICO'] },
