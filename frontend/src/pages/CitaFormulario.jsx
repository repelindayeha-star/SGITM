...
import { aInputDatetimeLocal } from '../utils/formato';
...
export default function CitaFormulario() {
  ...
  return (
    <Layout>
      ...
      <p className="text-taller-400 text-sm mb-7">Agenda una cita para un cliente y su motocicleta.</p>
        ...
        >
          ...
          <div className="mb-7">
            <Textarea
              ...
              placeholder="Revision general, cambio de aceite, ruido en frenos..."
            />
          </div>
